...
//#define MDEF_GLOBAL hmpdf_mdef_c // this should not be changed,
                                 //    since it's assumed in computation
                                 //    of the mass function
//now there is an input for HMF mass definition
...
struct DEFAULTS {int Ncores[3]; int verbosity; int warn_is_err;
                 ...
                 double *Duffy08_p; double *Tinker10_p; double *Battaglia12_p; double *Battaglia16_p; double *Lee22_BPL_p; double *TNG_p;  hmpdf_ne_profile_e ne_prof[3];
		 ...
		 char *Mgrid_f; char *Mweights_f; int adjust_Rout; char *out_dir_p; char *HMF_func; hmpdf_mdef_e HMF_mdef[3]; int interp_T08; double f_scatter; double xc_f_sigma; double xc_sample_Nxc; double xc_sample_dxc; double amp_f_sigma; double amp_sample_Namp; double amp_sample_damp};
