...
struct DEFAULTS def = { .Ncores={1,1,1000}, .verbosity=0, .warn_is_err=1,
                        ...
                        .dm_igm="none", .zgrid_f="none", .zweights_f="none", .Mgrid_f="none", .Mweights_f="none", .adjust_Rout=0, .out_dir_p="../data/", .HMF_func="T10", .HMF_mdef={hmpdf_mdef_m,0,hmpdf_mdef_m}, .interp_T08=0};
