...
//parameters from fit to IllustrisTNG
static double
def_TNG_density_params[]={1.56, 0.552, 0.926, //n0
                          7.83, 0.474, -0.520,//xc
                          1.0, 0.0, 0.0,//alpha
                          20.0, 0.644, -0.162,//beta
                         -0.3, 0.0, 0.0,//gamma
                          };
...
struct DEFAULTS def = { .Ncores={1,1,1000}, .verbosity=0, .warn_is_err=1,
                        ...
                        .dm_igm="none", .zgrid_f="none", .zweights_f="none", .Mgrid_f="none", .Mweights_f="none", .adjust_Rout=0, .out_dir_p="../data/", .HMF_func="T10", .HMF_mdef={hmpdf_mdef_m,0,hmpdf_mdef_m}, .interp_T08=0, .f_scatter=1.0};
